...
//4. Crear un objeto llamado Pokemon Master que tenga los siguientes atributos: id: number, name: string, created_date: string, y pokemon: array of objects.
 let pokemonMaster ={
    id: 1, 
    name:"Ash", created_date: new Date(), 
    pokemon: [{ id: 445, name: " Garchomp", type:"dragon" ,base_damage: 15, base_hp: 20, speed: 42}]
 }  
...
function calcuPokemonDamage(pokemon) {
...
let damage = calcuPokemonDamage(chosenPokemon);
